...
function SpectrogramView({ transcript, apiBase, seekRequest }) {
  ...
  const { text, units, words, audio_url: audioPath } = transcript;
  ...
  useEffect(() => {
    ...
    const ws = WaveSurfer.create({
      ...
      height: WAVE_HEIGHT,
      waveColor: "#4b5563",
      progressColor: "rgba(170, 59, 255, 0.5)",
      cursorColor: "#e04b4b",
      cursorWidth: 2,
      plugins: [
        regions,
    ...
    // Clicking an identified segment previews just that sound in isolation.
  ...
  const handleMouseMove = (e) => {
    ...
    setHoverZone(e.clientY - rect.top <= WAVE_HEIGHT ? "waveform" : "spectrogram");
  };
